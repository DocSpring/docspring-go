...
func (a *PDFApiService) GetFullTemplate(ctx context.Context, templateId string) (Template1, *http.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue Template1
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/templates/{template_id}?full=true"
	localVarPath = strings.Replace(localVarPath, "{"+"template_id"+"}", fmt.Sprintf("%v", templateId), -1)
...
/*
PDFApiService List all submissions
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ListSubmissionsOpts - Optional Parameters:
 * @param "Cursor" (optional.String) - 
 * @param "Limit" (optional.Float32) - 
 * @param "CreatedAfter" (optional.String) - 
 * @param "CreatedBefore" (optional.String) - 
...
/*
PDFApiService List all submissions for a given template
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param templateId
 * @param optional nil or *ListSubmissions_1Opts - Optional Parameters:
 * @param "Cursor" (optional.String) - 
 * @param "Limit" (optional.Float32) - 
 * @param "CreatedAfter" (optional.String) - 
 * @param "CreatedBefore" (optional.String) - 
