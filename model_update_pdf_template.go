...
// checks if the UpdatePdfTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdatePdfTemplate{}
...
type _UpdatePdfTemplate UpdatePdfTemplate

// NewUpdatePdfTemplate instantiates a new UpdatePdfTemplate object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewUpdatePdfTemplate(template map[string]interface{}) *UpdatePdfTemplate {
	this := UpdatePdfTemplate{}
	this.Template = template
	return &this
}

// NewUpdatePdfTemplateWithDefaults instantiates a new UpdatePdfTemplate object
...
func (o *UpdatePdfTemplate) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdatePdfTemplate := _UpdatePdfTemplate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdatePdfTemplate)

	if err != nil {
		return err
	}

	*o = UpdatePdfTemplate(varUpdatePdfTemplate)

	return err
}

type NullableUpdatePdfTemplate struct {
	value *UpdatePdfTemplate
	isSet bool
}

func (v NullableUpdatePdfTemplate) Get() *UpdatePdfTemplate {
	return v.value
}

func (v *NullableUpdatePdfTemplate) Set(val *UpdatePdfTemplate) {
	v.value = val
	v.isSet = true
}
...
func NewNullableUpdatePdfTemplate(val *UpdatePdfTemplate) *NullableUpdatePdfTemplate {
	return &NullableUpdatePdfTemplate{value: val, isSet: true}
}
